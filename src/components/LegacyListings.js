...
const LegacyListings = ({searchQuery, handleSearch}) => {
        ...
        <div className="col-md-3">
          <div className="search-container" style={{backgroundColor: "#febb02", paddingBottom: "20px", marginBottom: "10px" }}>
            ...
            <div className="input-group" style={{alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: "85%", marginLeft: "18px"}}>
              ...
              <input type="text" id="destination" style={{padding: "10px", height: '35px', width: '85%', border: 'none', fontSize: "0.85em"}} value="Inflation" placeholder= "Inflation"/>
            </div>   
            ...
            <div className="input-group" style={{alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: "85%", marginLeft: "18px"}}>
              ...
              <input type="text" id="check-in" style={{padding: "10px", height: '35px', width: '85%', border: 'none', fontSize: "0.85em"}} placeholder= "Saturday, July 1, 2023" value="Saturday, July 1, 2023"/>
            </div>
            <div className="input-group" style={{backgroundColor: "#febb02"}}>
            ...
            <div className="input-group" style={{alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: "85%", marginLeft: "18px"}}>
              ...
              <input type="text" id="check-out" style={{padding: "10px", height: '35px', width: '85%', border: 'none', fontSize: "0.85em"}} placeholder="Saturday, July 8, 2023" value="Saturday, July 8, 2023"/>
            </div>
            <div className="input-group" style={{backgroundColor: "#febb02"}}>
            ...
            <div className="input-group" style={{alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', width: "85%", marginLeft: "18px"}}>
              ...
              <input type="text" id="guests" style={{padding: "0px", height: '35px', width: '90%', border: 'none', fontSize: "0.85em"}} placeholder="2 adults - 0 children - 1 room" value="2 adults - 0 children - 1 room"/>
            </div>
            <div className="input-group" style={{backgroundColor: "#febb02"}}>
          ...
          <div className="filter-container" style={{backgroundColor: "white", marginBottom: "10px", paddingBottom: "20px"}}>
            ...
            <div style={{padding: "10px", border: '1px solid #e7e7e7'}}>
              ...
              <label style={{ display: "flex", alignItems: "center", marginTop: "10px", fontSize: "0.8em", justifyContent: "space-between" }}>
                ...
                <span>ETH0 - ETH1</span>
                <span style={{ marginLeft: "auto", color: "grey" }}>3</span>
              </label>
              <label style={{ display: "flex", alignItems: "center", marginTop: "10px", fontSize: "0.8em", justifyContent: "space-between" }}>
                <input type="checkbox" style={{ borderRadius: "2px", marginRight: "8px", fontSize: "0.1em" }} />
                <span>ETH1 - ETH2</span>
        ...
        <div className="col-md-9">
          <div className="row">
            <div className="col-md-8" style={{paddingTop: "20px"}}>
              <p style={{fontSize: "1.45em", textAlign: 'left', marginBottom: '0px'}}><strong>Inflation: 1 property found</strong></p>
              <p style={{fontSize: "1em", textAlign: 'left', paddingTop: "0px", color: "gray"}}> + 2 properties around Inflation </p>
            </div>
          ...
          <div className="row" style={{border: "1px solid #c6c6c6", borderRadius: "7px", marginBottom: '15px'}}>
            ...
            <div className="col-md-7" style={{width: "50%", paddingLeft: "0px"}}>
              <div className="hotel-text" style={{margin: "10px", textAlign: 'left'}}>
                <a href="#" onClick={() => navigate('/legacylisting')}><h5 style={{color: "#0071c2", display: 'inline-block', paddingRight: "10px"}} onMouseOver={(e) => e.target.style.color = 'black'} onMouseOut={(e) => e.target.style.color = '#0071c2'}>Hotel Poje</h5></a>
          ...
          <div className="input-group" style={{backgroundColor: "#fff0e0", border: "1px solid #ff8000", alignItems: 'center', width: "100%", marginBottom: "20px"}}>
            <div className="forsvg" style={{paddingBottom: "10px", paddingRight: "10px", paddingLeft: "10px", paddingTop: "7px"}}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.25 15.75h-.75a.75.75 0 0 1-.75-.75v-3.75a1.5 1.5 0 0 0-1.5-1.5h-.75a.75.75 0 0 0 0 1.5h.75V15a2.25 2.25 0 0 0 2.25 2.25h.75a.75.75 0 0 0 0-1.5zM11.625 6a1.125 1.125 0 1 0 0 2.25 1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z" fill="#923e01"/>
              </svg>
            </div>
            <p style={{fontSize: "0.9em", textAlign: "left", paddingTop: "15px"}}><strong>No properties left in Inflation on our site!</strong> Tip: Try these nearby properties...</p>
          </div>
          <div className="row" style={{border: "1px solid #c6c6c6", borderRadius: "7px", marginBottom: '15px'}}>
            <div className="col-md-3" style={{width: "28%"}}>
            ...
            <div className="col-md-7" style={{width: "50%", paddingLeft: "0px"}}>
              <div className="hotel-text" style={{margin: "10px", textAlign: 'left'}}>
                <h5 style={{color: "#0071c2", display: 'inline-block', paddingRight: "10px"}}>BFS Mist Hotel</h5>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '15px', fill: "white" }}>
                  <path d="M23.555 8.729a1.505 1.505 0 0 0-1.406-.98h-6.087a.5.5 0 0 1-.472-.334l-2.185-6.193a1.5 1.5 0 0 0-2.81 0l-.005.016-2.18 6.177a.5.5 0 0 1-.471.334H1.85A1.5 1.5 0 0 0 .887 10.4l5.184 4.3a.5.5 0 0 1 .155.543l-2.178 6.531a1.5 1.5 0 0 0 2.31 1.684l5.346-3.92a.5.5 0 0 1 .591 0l5.344 3.919a1.5 1.5 0 0 0 2.312-1.683l-2.178-6.535a.5.5 0 0 1 .155-.543l5.194-4.306a1.5 1.5 0 0 0 .433-1.661z" fill="#ffb700"/>
                </svg>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '15px', fill: "white" }}>
          ...
          <div className="row" style={{border: "1px solid #c6c6c6", borderRadius: "7px", marginBottom: '15px'}}>
            ...
            <div className="col-md-7" style={{width: "50%", paddingLeft: "0px"}}>
              <div className="hotel-text" style={{margin: "10px", textAlign: 'left'}}>
                <h5 style={{color: "#0071c2", display: 'inline-block', paddingRight: "10px"}}>Def Sands Resort</h5>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '15px', fill: "white" }}>
                  <path d="M23.555 8.729a1.505 1.505 0 0 0-1.406-.98h-6.087a.5.5 0 0 1-.472-.334l-2.185-6.193a1.5 1.5 0 0 0-2.81 0l-.005.016-2.18 6.177a.5.5 0 0 1-.471.334H1.85A1.5 1.5 0 0 0 .887 10.4l5.184 4.3a.5.5 0 0 1 .155.543l-2.178 6.531a1.5 1.5 0 0 0 2.31 1.684l5.346-3.92a.5.5 0 0 1 .591 0l5.344 3.919a1.5 1.5 0 0 0 2.312-1.683l-2.178-6.535a.5.5 0 0 1 .155-.543l5.194-4.306a1.5 1.5 0 0 0 .433-1.661z" fill="#ffb700"/>
                </svg>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '15px', fill: "white" }}>
